...
load.resolve = function resolve(filename, source, options) {
  ...
  options.basedir = '/Users/aakoch/projects/adamkoch.com/'
  ...
  //   filename
  // );
  if (filename === 'head.pug' || filename === './head.pug' || filename == "/src/templates/head'.pug") {
      filename = '/src/templates/head.pug'
  }
  if (filename == "../'/src/templates/footer.pug'" || filename == "../../'/src/templates/footer.pug'" || filename == "/src/templates/../'/src/templates/footer.pug" || filename == "/src/templates/../../'/src/templates/footer.pug") {
    filename = '/src/templates/footer.pug'
  }
  ...
  try {
    ...
    console.error('options.basedir =' + options.basedir)
    console.error('filename before =' + filenameBefore)
    console.error('filename after  =' + filename)
  }
